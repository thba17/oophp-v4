...
class Page implements /* PageRenderInterface, */ InjectionAwareInterface
{
    ...
    public function render($data, $status = 200)
    {
        ...
        // $data["favicon"] = "http://localhost/dbwebb-kurser/oophp/me/redovisa/htdocs/favicon.ico";
        $data["stylesheets"] = ['https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css"
